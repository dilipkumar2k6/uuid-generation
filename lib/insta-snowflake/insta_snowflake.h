...
const uint64_t MAX_INSTA_SHARD_ID = (static_cast<uint64_t>(1) << INSTA_SHARD_ID_BITS) - 1;
const uint64_t MAX_INSTA_SEQUENCE = (static_cast<uint64_t>(1) << INSTA_SEQUENCE_BITS) - 1;

const uint64_t INSTA_SHARD_ID_SHIFT = INSTA_SEQUENCE_BITS;
const uint64_t INSTA_TIMESTAMP_SHIFT = INSTA_SEQUENCE_BITS + INSTA_SHARD_ID_BITS;
