...
This directory contains the C++ implementation of the Instagram Sharding Variation of the Snowflake ID generation algorithm. This variation is optimized for database sharding.
