...
This directory contains the C++ implementation of the Sonyflake Variation of the Snowflake ID generation algorithm. This variation was originally created by Sony.
