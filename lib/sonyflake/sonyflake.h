...
const uint64_t MAX_SONY_SEQUENCE = (static_cast<uint64_t>(1) << SONY_SEQUENCE_BITS) - 1;
const uint64_t MAX_SONY_MACHINE_ID = (static_cast<uint64_t>(1) << SONY_MACHINE_ID_BITS) - 1;
