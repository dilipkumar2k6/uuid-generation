...
This directory contains the C++ implementation and Docker setup for the Database Auto-Increment approach to ID generation. This approach was popularized by Flickr's Ticket Server.
...
Before running the C++ generator with `GENERATOR_TYPE=DB_AUTO_INC`, you must deploy the database tier to your Kubernetes cluster:
