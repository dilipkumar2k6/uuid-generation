...
This directory contains the implementation of the 64-bit Hybrid Logical Clock (HLC) Snowflake ID generation algorithm. This algorithm combines physical time with a logical counter to provide high availability. 
